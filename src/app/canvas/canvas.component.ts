import { Component, AfterViewInit, OnChanges, OnDestroy, Input, Output, EventEmitter, OnInit} from '@angular/core';
...
class CanvasComponent {
  ...
  static _cjsChartContainerId = 0;
	...
	constructor() {
		...
		this.chartContainerId = 'canvasjs-angular-chart-container-' + CanvasComponent._cjsChartContainerId++;
	}
